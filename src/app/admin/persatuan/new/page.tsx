...
export default function NewPersatuan() {
  ...
  return (<div>
    <div className="flex items-center gap-3 mb-6"><Link href="/admin/persatuan" className="text-gray-400 text-sm">← Persatuan</Link><h1 className="font-display text-xl md:text-2xl text-dark">New Persatuan</h1></div>
    <div className="bg-white rounded-xl p-5 md:p-8 shadow-sm border border-gray-100 max-w-3xl"><div className="flex flex-col gap-5">
      ...
      <button className="bg-saffron text-white px-6 py-3 rounded-xl font-bold text-sm self-start">Save</button>
    </div></div>
  </div>);
}
