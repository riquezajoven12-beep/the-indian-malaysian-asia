    ...
    <div>
      ...
      <div className="bg-white rounded-xl p-5 md:p-8 shadow-sm border border-gray-100 max-w-3xl">
        <div className="flex flex-col gap-5">
          ...
          <div><label className="block text-xs font-semibold text-gray-500 mb-1">Link URL</label><input className={c} defaultValue="/news" /></div>
          <button className="bg-saffron text-white px-6 py-3 rounded-xl font-bold text-sm self-start">Update Featured</button>
        </div>
      </div>
    </div>
  );
