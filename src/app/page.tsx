  ...
  return (
    <div style={{ fontFamily: 'Source Sans 3, sans-serif', background: '#FFFCF7', color: '#2D2D2D', lineHeight: 1.7 }}>
      ...
      <header style={{ background: '#FFFCF7', borderBottom: '1px solid rgba(212, 175, 55, 0.3)', position: 'sticky', top: 0, zIndex: 1000 }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 40px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 0', borderBottom: '1px solid rgba(212, 175, 55, 0.3)' }}>
            ...
            <Link href="/subscribe" style={{ background: 'linear-gradient(135deg, #FF6B00 0%, #8B1538 100%)', color: 'white', padding: '12px 28px', fontWeight: 600, fontSize: '0.9rem', borderRadius: '4px' }}>
              SUBSCRIBE
            </Link>
          </div>
          <nav style={{ display: 'flex', justifyContent: 'center', gap: '40px', padding: '18px 0' }}>
            ...
            <Link href="/about" style={{ color: '#2D2D2D', fontWeight: 500, fontSize: '0.95rem' }}>Our Roots</Link>
            <Link href="/education" style={{ color: '#2D2D2D', fontWeight: 500, fontSize: '0.95rem' }}>Education</Link>
            <Link href="/temples" style={{ color: '#2D2D2D', fontWeight: 500, fontSize: '0.95rem' }}>Religion & Culture</Link>
            <Link href="/persatuan" style={{ color: '#2D2D2D', fontWeight: 500, fontSize: '0.95rem' }}>Persatuan</Link>
      ...
      <section style={{ padding: '100px 40px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '30px' }}>
          <Link href="/news">
            <div style={{ background: 'white', border: '1px solid rgba(212, 175, 55, 0.3)', overflow: 'hidden', borderRadius: '12px' }}>
              ...
              <div style={{ padding: '25px' }}>
                ...
                <p style={{ color: '#666', fontSize: '0.9rem', marginBottom: '15px' }}>The government unveils comprehensive plan to boost opportunities for the community.</p>
          ...
          <Link href="/news">
            <div style={{ background: 'white', border: '1px solid rgba(212, 175, 55, 0.3)', overflow: 'hidden', borderRadius: '12px' }}>
              <div style={{ height: '220px', position: 'relative', overflow: 'hidden' }}>
                ...
                <span style={{ position: 'absolute', top: '15px', left: '15px', background: '#FF6B00', color: 'white', padding: '6px 15px', fontSize: '0.75rem', fontWeight: 600, textTransform: 'uppercase', borderRadius: '4px' }}>Education</span>
              </div>
              <div style={{ padding: '25px' }}>
                <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.3rem', fontWeight: 600, color: '#1A1A1A', marginBottom: '12px', lineHeight: 1.4 }}>Tamil Schools See Record Enrollment in Mother Tongue Education</h3>
                <p style={{ color: '#666', fontSize: '0.9rem', marginBottom: '15px' }}>Parents increasingly value Tamil language education for cultural development.</p>
                <span style={{ fontSize: '0.85rem', color: '#FF6B00', fontWeight: 600 }}>Read More →</span>
              </div>
            </div>
          </Link>
          <Link href="/news">
            <div style={{ background: 'white', border: '1px solid rgba(212, 175, 55, 0.3)', overflow: 'hidden', borderRadius: '12px' }}>
              <div style={{ height: '220px', position: 'relative', overflow: 'hidden' }}>
                <img src="https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=800&q=80" alt="Batu Caves" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                <span style={{ position: 'absolute', top: '15px', left: '15px', background: '#FF6B00', color: 'white', padding: '6px 15px', fontSize: '0.75rem', fontWeight: 600, textTransform: 'uppercase', borderRadius: '4px' }}>Culture</span>
              </div>
              <div style={{ padding: '25px' }}>
                <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.3rem', fontWeight: 600, color: '#1A1A1A', marginBottom: '12px', lineHeight: 1.4 }}>Batu Caves Prepares for Largest Thaipusam Celebration</h3>
                <p style={{ color: '#666', fontSize: '0.9rem', marginBottom: '15px' }}>Over 1.5 million devotees expected to attend the annual festival.</p>
                <span style={{ fontSize: '0.85rem', color: '#FF6B00', fontWeight: 600 }}>Read More →</span>
              </div>
            </div>
          </Link>
      ...
      <section style={{ background: '#1A1A1A', padding: '80px 0' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 40px' }}>
          <h2 style={{ fontFamily: 'Playfair Display, serif', fontSize: '2rem', textAlign: 'center', color: 'white', marginBottom: '50px' }}>Our Community in Numbers</h2>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 40px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr', gap: '50px', marginBottom: '60px' }}>
            ...
            <div>
              ...
              <ul>
                ...
                <li style={{ marginBottom: '12px' }}><Link href="/news" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Business</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/news" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Education</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/news" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Culture</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/news" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Sports</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul>
                <li style={{ marginBottom: '12px' }}><Link href="/persatuan" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Persatuan Directory</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/temples" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Temple Finder</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/events" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Events Calendar</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/jobs" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Job Board</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul>
                <li style={{ marginBottom: '12px' }}><Link href="/education" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Tamil Schools</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/education" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Scholarships</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/education" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Online Courses</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/education" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Career Resources</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul>
                ...
                <li style={{ marginBottom: '12px' }}><Link href="/about" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Editorial Team</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/contact" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Advertise</Link></li>
                <li style={{ marginBottom: '12px' }}><Link href="/contact" style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>Contact Us</Link></li>
              </ul>
            </div>
          </div>
          <div style={{ paddingTop: '30px', borderTop: '1px solid rgba(255, 255, 255, 0.1)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '30px' }}>
              <Link href="/privacy" style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '0.85rem' }}>Privacy Policy</Link>
              <Link href="/terms" style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '0.85rem' }}>Terms of Service</Link>
            </div>
          </div>
        </div>
      </footer>
